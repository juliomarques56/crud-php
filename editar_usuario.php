    ...
    <div class="container"  style="width: 400px; margin-top: 40px;">
        ...
        ?>
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nomeusuario" value="<?php echo $nomeusuario?>" placeholder="Nome">
                <input type="text" class="form-control" name="id" value="<?php echo $id?>" style="display:none">
            </div>
            <div class="form-group">
                <label>E-mail</label>
                <input type="email" class="form-control" name="emailusuario" value="<?php echo $email?>" placeholder="E-mail">
            </div>
            <div class="form-group">
